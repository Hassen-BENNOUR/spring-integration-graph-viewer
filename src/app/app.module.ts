...
import { D3ForceDirectedGraphViewerComponent } from './d3-force-directed-graph-viewer/d3-force-directed-graph-viewer.component';
...
import { D3ForceDirectedCurvedGraphViewerComponent } from './d3-force-directed-curved-graph-viewer/d3-force-directed-curved-graph-viewer.component';
import 'zone.js';
...
@NgModule({
  ...
  imports: [MatFormFieldModule, MatSelectModule, MatInputModule, BrowserModule, FormsModule, HttpClientModule],
  providers: [],
